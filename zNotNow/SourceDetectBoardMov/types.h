...
typedef simplelist<cluster_t,1000> clusters_list_t;

// Specifies a list of lines.
typedef simplelist<line_t,1000> lines_list_t;

// A 2x2 matrix.
typedef double matrix_t[4];

// Specifies a string of adjacent feature pixels.
typedef simplelist<pixel_t,500> string_t;

// Specifies a list of string of feature pixels.
typedef simplelist<string_t,1000> strings_list_t;
